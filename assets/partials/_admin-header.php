<?php
    ...
    $sql = "SELECT * FROM administrators WHERE id = $user_id";
...
<!-- <header>
    ...
    <main id="container">
        <div id="sidebar">
            <h4><i class="fas fa-bus"></i> Manila Travels</h4>
            <div>
                <img class="adminDp" src="../assets/img/userav-min.png" height="200px" alt="Admin Profile Pic">
                <p>
                    <?php  echo '@'.$user_name;  ?>
                </p>
