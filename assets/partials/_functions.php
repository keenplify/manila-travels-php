<?php
    ...
    function exist_routes($conn, $Location, $depdate, $deptime)
    {
        $sql = "SELECT * FROM `routes` WHERE route_location='$Location' AND route_dep_date='$depdate' AND route_dep_time='$deptime'";
