...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">Manila Travels</a>
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Manila Travel Bus Ticketing System</h1>

            <p class="text-center">Welcome to Manila Travel Bus Ticketing System. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                    Manila Travels automates the time-consuming process of booking a bus ticket for each trip performed to our preferred bus transit. Manila Travels believes that this application is an automated system, and that clients can choose which seats and schedule they want. Clients can reserve and purchase tickets through our application, and Manila Travels is a designed system that will allow clients to verify the availability of buses online as well as information about bus routes and schedules.
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Manila Travel Bus Ticketing System
                        </p>
        </footer>
    </div>
